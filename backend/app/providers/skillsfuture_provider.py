    ...
    async def fetch(self) -> ProviderResult:
        ...
        courses = [
            NormalizedCourse(
                ...
                base_credit_eligible=c.get("base_credit_eligible", True),
                mid_career_eligible=c.get("mid_career_eligible", False),
                sctp_eligible=c.get("sctp_eligible", False),
                level_up_eligible=c.get("level_up_eligible", False),
                location="Singapore",
                url=c.get("url", ""),
                image_url="",
                skills=c.get("skills", []),
